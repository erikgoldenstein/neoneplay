...
const Settings = () => {
    ...
    useEffect(() => {
        ...
        cleanServer()
        addServer("Fraunhofer", "ne-one.de/airline", "", "#009374");
        addServer("Fraport", "fra-1a.one-record.lhind.dev", globalToken, "#2b4d96") // Fraport - GroundHandler
        addServer("DB Schenker", "fra-1b.one-record.lhind.dev", globalToken, "#C1121C") // DBSchenker - Forwarder
        addServer("1R Security", "fra-1c.one-record.lhind.dev", globalToken, "#edc843") // CEWA - SecurityAgent
        addServer("Riege Software", "fra-1d.one-record.lhind.dev", globalToken, "#a0a056")  // Riege - Shipper
        addServer("Lufthansa Cargo", "fra-1.one-record.lhind.dev", globalToken, "#122447") // LH Cargo - Airline
    }, [])
    ...
    return (
        ...
        <>
            <div class='has-tooltip '>
                <span class='tooltip rounded shadow-lg p-1 bg-slate-200 dark:bg-slate-600 text-slate-600 dark:text-slate-200 mt-12 -ml-10  duration-200 transition-colors' >Change Database</span>
